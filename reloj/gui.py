...
WATCH_SKIN_PRESETS = [
    WatchSkin(
        ...
        background_gradient=("#101522", "#161c29", "#222a36"),
        case_gradient=("#d7dadd", "#9fa5aa", "#6b7076"),
        dial_gradient=("#fdfdfd", "#dcdfe3", "#a8adb3"),
        highlight_color="#e5e7eb",
        accent_text_color="#111827",
        major_marker_color="#f8fafc",
        minor_marker_color="#cbd5e1",
        minute_dot_color="#a9b1bb",
        inner_ring_color="#dfe3e8",
        numeral_color="#111827",
        hour_hand_color="#6b7280",
        minute_hand_color="#1f2937",
        second_hand_color="#cbd5e1",
        second_counter_weight_color="#9ca3af",
        center_cap_border_color="#f8fafc",
        center_cap_base_color="#1f2937",
        center_cap_fill_color="#f8fafc",
        time_background_rgba="rgba(15, 23, 42, 160)",
        time_text_color="#f8fafc",
        ui_accent_color="#f3f4f6",
        ui_accent_text_color="#111827",
        frame_image_path="audemars_piguet.png",
    ),
    WatchSkin(
        name="Audemars Piguet Gold",
        background_gradient=("#101522", "#161c29", "#222a36"),
        case_gradient=("#d7dadd", "#9fa5aa", "#6b7076"),
        dial_gradient=("#fdfdfd", "#dcdfe3", "#a8adb3"),
        highlight_color="#e5e7eb",
        ...
        ui_accent_color="#f3f4f6",
        ui_accent_text_color="#111827",
        frame_image_path="audemars_piguet_gold.png",
    ),
]
